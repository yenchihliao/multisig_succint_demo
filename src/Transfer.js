...
const Transfer = ({ show }) => {
  ...
  const submitSignHandler = async () => {
    ...
    const amount = padTo32Bytes(
      parseInt(document.getElementById("amount_tranfer").value).toString(16)
    );
  ...
  return (
    <div className={show ? "transfer hide" : "transfer"}>
      ...
      <div>
        {" "}
        <span className="outputs"> Pool found: {poolFound} </span>
      ...
      <input
        ...
        size="40"
        defaultValue="345a918050012C5967473087e76E6B7c708Cb0C8"
      ></input>
      <br></br>
      to:{" "}
      <input
        ...
        placeholder="address without '0x'"
        size="40"
        defaultValue="B7B286b5a4a9004Ef972864469A0C49E35B505E4"
      ></input>
      <br></br>
      amount:{" "}
      <input type="text" id="amount_tranfer" defaultValue="1000000000"></input>
      <br></br>
      ...
      <div>
        ...
        <span className="outputs">
          {" "}
          Signatures: {count} out of {sigNeeded}{" "}
        </span>{" "}
      </div>
      <div>
        {" "}
